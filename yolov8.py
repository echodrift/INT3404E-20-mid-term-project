...
if __name__ == "__main__":
    ...
    results = model.train(data = dataset, batch = 4, epochs = 100, imgsz = 928, seed = 18022004, device = [0, 1], save_period = 5, name = 'v8x_base')
    ...
    results = model.train(data = dataset, batch = 4, epochs = 100, imgsz = 928, seed = 18022004, device = [0, 1], save_period = 5, name = 'v8x_augmented')